...
t:=0
string1 = rpg cd {Enter}
string2 = rpg p {Enter}
string3 = rpg i {Enter}
string4 = rpg guild{Enter}

Timers:

Random, time, 5, 10
time := time * 1000
SetTimer, AntiJail, %time%
...
Random, time, 7200, 7260
time := time * 1000
SetTimer, Guild, %time%

Random, time, 65, 550
time := time * 1000
SetTimer, Cooldown, %time%

Random, time, 10800, 11000
time := time * 1000
SetTimer, Lootbox, %time%

Random, time, 3610, 3625
time := time * 1000
SetTimer, Adventure, %time%

Random, time, 86400, 87000
time := time * 1000
SetTimer, Daily, %time%

;Random, time, 930, 1000
;time := time * 1000
;SetTimer, Training, %time%
return
...
Work:
send, rpg axe {Enter} ;Can be edited to any command you wish
sleep, 1000
return
...
Daily:
send, rpg daily {Enter}
sleep, 1000
return

;Training:
;run, C:\Users\Admin\Desktop\ERPG Bot\lib\training.ahk
;sleep, 15000
;return
...
Guild:
send, rpg guild raid{Enter}
sendUpdate("Done Guild Command")
...
Text:="|<>**50$58.DzxyTbzzy1kAK93M70QA0lMgBUA0Mlv5WkKQFlyDwK+1tl7XMzlMt7bASBX35XaC0lcyAAKAMs77W8wltk3YQS8lnX706Mllz0C0MwNV07L0w3aFb41xDyTztzzzyy"

Text.="|<>*125$58.zzzzztzySDzzzzzbztyzzzzzzzzzv0kQ7z1sMTgHBaTzbRtynhmNzyTrbvDr9jztkSTgzQUzzaRtynxazzyNbbvDks7ztkM43zTjTzbzzzzxytzyTzzzzrsDz3zzzy"

if (ok:=FindText(474-150000, 332-150000, 474+150000, 332+150000, 0, 0, Text))
{
	CoordMode, Mouse
	X:=ok.1.x, Y:=ok.1.y, Comment:=ok.1.id
	sendHost("I have been in jail for " t++ " times")
		sleep, 1000
;			Run, ItemData
;	send, {Enter}
;	sleep, 2000
...
sendHost(msg){
	url:="https://discord.com/api/webhooks/885677453874458634/rbUGHulfxZyS7TRul7En02ErhrZlNBlXs1Tb9dK5gCbLDCvQyHK7GJu1tosvDZ7vjEoV" ; use the url from Discord webhook bot
	postdata=
    (
    {
	    "content": "%msg%"
    }
    ) ;Use https://leovoel.github.io/embed-visualizer/
